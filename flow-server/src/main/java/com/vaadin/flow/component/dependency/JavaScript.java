...
public @interface JavaScript {
    ...
    enum Type {
         ...
         * private to the module unless explicitly exported. The file is
         * loaded at runtime and is not bundled, even when the URL is a bare
         * relative path. Use this for hand-authored or CDN-hosted modules
         * that should not go through Vite. For build-time bundled ES modules
         * use {@link JsModule} instead.
         */
        MODULE
    }
     ...
     * instead, e.g. for hand-authored or CDN-hosted ES modules that should
